...
$(document).ready(function(){
  ...
  a.click();
    ...
    if (hasil == 'view')
    {
       $.ajax({
        type  : "POST",
        url   : "data.php?page=laporan_penjualan",
        data  : {tgl1: tgl1, tgl2 : tgl2 },
        success : function(data){
           $('.data').show();
          $("#data-penjualan").html(data).show();

        }
        });

      /* window.location.href = ' media.php?page=laporan-penjualan&tgl1='+tgl1+'&tgl2='+tgl2;*/

      
    } 
    else if (hasil == 'excel')
    {
        window.location.href = 'data.php?page=penjualan_excel&tgl1='+tgl1+'&tgl2='+tgl2;
    }
    else
    {
        
        openInNewTab('data.php?page=penjualan_pdf&tgl1='+tgl1+'&tgl2='+tgl2);
